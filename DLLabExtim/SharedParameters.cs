...
namespace DLLabExtim
{
    public class SharedConfiguration
    {
        ...
        public SharedConfiguration(int machineCode)
        {

            try
            {
                FtpBaseUrl = ConfigurationManager.AppSettings["ftpBaseUrl_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                FtpInputPath = ConfigurationManager.AppSettings["ftpInputPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                FtpOutputPath = ConfigurationManager.AppSettings["ftpOutputPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                FtpUsername = ConfigurationManager.AppSettings["ftpUsername_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                FtpPassword = ConfigurationManager.AppSettings["ftpPassword_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocRootPath = ConfigurationManager.AppSettings["locRootPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocInputPath = ConfigurationManager.AppSettings["locInputPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocOutputPath = ConfigurationManager.AppSettings["locOutputPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocErrorPath = ConfigurationManager.AppSettings["locErrorPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocArchInPath = ConfigurationManager.AppSettings["locArchInPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
            ...
            try
            {
                LocArchOutPath = ConfigurationManager.AppSettings["locArchOutPath_" + machineCode.ToString()].ToString();
            }
            catch (Exception _ex)
            {
