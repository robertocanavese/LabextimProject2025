<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="$rootnamespace$.Autocomplete_Filter" Codebehind="Autocomplete.ascx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:TextBox runat="server" ID="AutocompleteTextBox" Width="300" autocomplete="off" CssClass="DDFilter" />
<asp:HiddenField
    runat="server" 
    ID="AutocompleteValue" 
    OnValueChanged="AutocompleteValue_ValueChanged"/>
<asp:Button runat="server" ID="ClearButton" OnClick="ClearButton_Click" Text="Clear" CssClass="DDFilter" />
