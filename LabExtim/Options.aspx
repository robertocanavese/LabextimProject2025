...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="verticalLines">
        ...
        <tr>
            <td colspan="6" align="center">
                <asp:Button ID="btnRestoreLast" runat="server" Text="Ripristina" OnClientClick="javascript:return confirm('Confermi il ripristino dei dati esistenti prima dell'ultimo aggiornamento? (N.B.: la selezione corrente (date, fornitore, etc:..) in questo caso è ininfluente)';"
                    CssClass="myButton" OnClick="btnRestoreLast_Click" /><br />
