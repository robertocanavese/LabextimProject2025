<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionOrderDetailsInsertByO3.aspx.cs"
    Inherits="LabExtim.ProductionOrderDetailsInsertByO3" MasterPageFile="~/Site.master"
                ...
                <asp:Panel ID="DetailsPanel" runat="server">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="padding-right: 10px">
                                <asp:Label ID="lblOdP" runat="server" Text="Id OdP (solo azienda corrente!)"></asp:Label>
                            </td>
                            <td style="padding-right: 10px">
                        ...
                        <tr>
                            <td style="padding-right: 10px">
                                <asp:DropDownList ID="ddlEmployees" runat="server" AutoPostBack="true" DataSourceID="ldsOwner"
                                    DataTextField="UniqueName" DataValueField="ID" CssClass="droplist" OnSelectedIndexChanged="ddlEmployees_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:LinqDataSource ID="ldsOwner" runat="server" ContextTypeName="DLLabExtim.QuotationDataContext"
                                    TableName="Employees" OrderBy="UniqueName" OnSelected="ldsOfaDropDownList_Selected">
                                </asp:LinqDataSource>
                            </td>
                            <td style="padding-right: 10px">
                            ...
                            <td style="padding-right: 10px">
                                <cfb:IntTextBox ID="itbNoOdP" runat="server" CssClass="droplist" ShowFindButton="true"></cfb:IntTextBox>
                            </td>
                            <td style="padding-right: 10px">
                                <cfb:YearCounterTextBox ID="yctNumber" runat="server" CssClass="droplist" ShowFindButton="true"></cfb:YearCounterTextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblOverTimeMessage" runat="server" ForeColor="Olive"></asp:Label>&nbsp;
                            </td>
                        </tr>
                    </table>
                    <br />
                </asp:Panel>
                <h5>Dettaglio denuncia giornaliera per operatore</h5>
                <%--<asp:UpdatePanel ID="updDetail" runat="server">
            <ContentTemplate>--%>
                    ...
                    DefaultValue="" />
                            ...
                            AutoGenerateColumns="false" >--%>
                                ...
                                <asp:LinqDataSource ID="ldsPhase" runat="server" ContextTypeName="DLLabExtim.QuotationDataContext"
                                    TableName="PickingItems" OrderBy="ItemDescription" OnSelecting="ldsOfaDropDownList_Selecting" OnSelected="ldsOfaDropDownList_Selected">
                                </asp:LinqDataSource>
                                ...
                                Text="Modifica" />&nbsp;--%>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="txtID_ProductionOrder" runat="server" Text='<%# Eval("ID_ProductionOrder") %>'
                                                    CssClass="droplist" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <cfb:IntTextBox ID="txtID_ProductionOrder" runat="server" CssClass="droplist" Text='<%# Bind("ID_ProductionOrder") %>' />
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <cc1:MaskedEditValidator ID="mevProductionTime" runat="server" ControlToValidate="txtProductionTime"
                                                    ControlExtender="meeProductionTime" IsValidEmpty="true"
                                                    SetFocusOnError="true" Display="None"></cc1:MaskedEditValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
