<%@ Control Language="C#" CodeBehind="Find_DateTime_Edit.ascx.cs" Inherits="LabExtim.DynamicData.FieldTemplates.Find_DateTime_EditField" %>
...
<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/DynamicData/Content/Images/Calendar.png"
    ImageAlign="Middle" />
<cc1:CalendarExtender ID="TextBox1_CalendarExtender" runat="server" FirstDayOfWeek="Monday" CssClass="MyCalendar"
