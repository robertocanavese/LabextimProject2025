<%@ Control Language="C#" CodeBehind="DateTime_EditRO.ascx.cs" Inherits="LabExtim.DynamicData.FieldTemplates.DateTime_EditFieldRO" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:TextBox ID="TextBox1" runat="server" CssClass="droplist" Text='<%# FieldValueEditString %>'
    Columns="10" Enabled="false" ></asp:TextBox>
<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/DynamicData/Content/Images/Calendar.png"
    ImageAlign="Middle" Enabled="false" />
<cc1:CalendarExtender ID="TextBox1_CalendarExtender" runat="server" 
    FirstDayOfWeek="Monday" CssClass="MyCalendar"
    PopupButtonID="ImageButton1" TargetControlID="TextBox1" 
    PopupPosition="Right" 
    SelectedDate='<%# (FieldValueEditString == String.Empty) ? DateTime.Today : Convert.ToDateTime(FieldValueEditString) %>' Enabled="false"  
    >
