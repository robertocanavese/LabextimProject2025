<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="QuotationInsert2.aspx.cs"
         Inherits="LabExtim.QuotationInsert2" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:LinqDataSource ID="DetailsDataSource" runat="server" EnableInsert="true" OnInserted="DetailsDataSource_Inserted"
                                ContextTypeName="DLLabExtim.QuotationDataContext" TableName="TempQuotations">
            </asp:LinqDataSource>
            <br />
