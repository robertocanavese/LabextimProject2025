<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True"
    CodeBehind="ProductionOrdersStatsDDT.aspx.cs" Inherits="LabExtim.ProductionOrdersStatsDDT"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h2>Redditività DDT/ordini di produzione
                        ...
                        <td>
                            <table class="searchEngine">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblNumber" runat="server" Text="Anno/Numero DDT"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblTitleContains" runat="server" Text="Titolo Odp contiene..."></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <cfb:YearCounterTextBox ID="yctNumber" runat="server" CssClass="droplist" ShowFindButton="false" DDTMode="true"></cfb:YearCounterTextBox>
                                    </td>
                                    <td>
                            ...
                            <asp:GridView ID="grdProductionOrdersStats" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <%--0--%>
                                     <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="lblNumbolla" runat="server" Text="No DDT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="lblDataBolla" runat="server" Text="Data DDT"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:DynamicControl ID="dycDataBolla" runat="server" DataField="DataBolla" UIHint="DateTime"
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="70">
                                        ...
                                        <ItemTemplate>
                                            <asp:DynamicControl ID="dycPORPropHistoricalCost" runat="server" DataField="PORPropHistoricalCost"
