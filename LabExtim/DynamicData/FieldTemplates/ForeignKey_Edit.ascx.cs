...
namespace LabExtim.DynamicData.FieldTemplates
{
    public partial class ForeignKey_EditField : FieldTemplateUserControl
    {
        ...
        //    get
        //    {
        //        if (this.Attributes["IDCompany"] == null)
        //            return "-1";
        //        return this.Attributes["IDCompany"];
        //    }
        //    set
        //    {
        //        this.Attributes["IDCompany"] = value.ToString();
        //    }
        //}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (DropDownList1.Items.Count == 0)
            {
                ...
                if (ForeignKeyColumn.ParentTable.Name.Contains("Statuse") && Table.Name.Contains("ProductionOrderTechSpecs"))
                {
                ...
                {
                    Sql += " WHERE 1=1 ";
                    if (Table.Name.Contains("TempQuotations") || Table.Name.Contains("Find_Quotations") || Table.Name.Contains("DeliveryTrips"))
                    {
                        Sql += " AND Name not like '**%'";
                    }
                    // merge aziendale
                    //if (Session["CurrentCompanyId"].ToString() == "1")
                    //{
                        Sql += " AND code between 1 and 199999999";
                    //}
                    //if (Session["CurrentCompanyId"].ToString() == "2")
                    //{
                    //    Sql += " AND code between 200000000 and 299999999";
                    //}
                }

                // merge aziendale
                //if (Column.Name == "Supplier" && Session["CurrentCompanyId"].ToString() == "1")
                if (Column.Name == "Supplier")
                {
                    Sql += " WHERE code between 1 and 199999999";
                }
                //if (Column.Name == "Supplier" && Session["CurrentCompanyId"].ToString() == "2")
                //{
                //    Sql += " WHERE code between 200000000 and 299999999";
                //}
