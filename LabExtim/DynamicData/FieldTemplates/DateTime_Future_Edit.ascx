<%@ Control Language="C#" CodeBehind="DateTime_Future_Edit.ascx.cs" Inherits="LabExtim.DynamicData.FieldTemplates.DateTime_Future_EditField" %>
...
<cc1:CalendarExtender ID="TextBox1_CalendarExtender" runat="server" 
    ...
    PopupPosition="Right" 
    SelectedDate='<%# (FieldValueEditString == String.Empty) ? DateTime.Today.AddDays(-1) : Convert.ToDateTime(FieldValueEditString) %>'  
    >
