<%@ Control Language="C#" AutoEventWireup="true" Inherits="LabExtim.Autocomplete_EditField" Codebehind="Autocomplete_Edit.ascx.cs" %>
<asp:TextBox runat="server" ID="AutocompleteTextBox" autocomplete="off"
    CssClass="DDFilter droplist" Width="250" />
...
<ajaxToolkit:AutoCompleteExtender runat="server" BehaviorID="AutoCompleteBehaviorIDPlaceholder"
    ...
    EnableCaching="false" CompletionSetCount="40" CompletionListCssClass="autocomplete_completionListElement"
